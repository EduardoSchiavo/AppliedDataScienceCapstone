...
def get_pie_chart(entered_site):
    ...
    if entered_site == "ALL":
        fig= px.pie(spacex_df, values='class', names='Launch Site', title='Success rate on all sites')
        return fig
    else:
        fig1= px.pie(grouped_df, values='class count', names='class', title=f'Success rate of site {entered_site}')
        return fig1
...
def plot_payload_scatter(site, payload):
    ...
    if site == "ALL":
        ...
        fig1.update_layout(xaxis_range=payload)
        return fig1
